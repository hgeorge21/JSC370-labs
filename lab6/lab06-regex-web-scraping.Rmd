...
```{r one-string-per-response, eval = T, echo=F}
...
View [here](https://github.com/hgeorge21/JSC370-labs/blob/master/lab6/lab06-regex-web-scraping.html)
